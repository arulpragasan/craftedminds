...
export function Stories() {
  ...
  const sentences = [
    'Crafted is where luxury brands transform products into stories.',
      ...
      <div className="relative z-10 w-full max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="relative aspect-square lg:aspect-auto lg:h-[500px] w-full rounded-sm overflow-hidden bg-card"
          >
            <Image
